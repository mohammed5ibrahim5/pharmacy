...
// Save colors and header config inside features_json
  ...
  // ===== قوالب الأبيض والأسود (أحادية اللون) — كل قالب ب设计 فريد =====
  const monoPresets: ColorPreset[] = [
    buildMonoPreset('ورقي نقي', '📄', 'بياض دافئ مع لمسات فحمية', {
      ...
      primaryColor: '#2a2a2a', secondaryColor: '#5a5a5a', accentColor: '#9a9590',
      statsCardBg: '#ffffff', statsCardText: '#1a1a1a',
      pharmacyHoverBorder: '#1a1a1a',
      footerBg: '#1a1a1a', footerText: '#c8c3be',
    }),
    buildMonoPreset('فضي أنيق', '🪙', 'بريق فضي بدرجات باردة', {
      ...
      primaryColor: '#3a3a3c', secondaryColor: '#636366', accentColor: '#aeaeb2',
      statsCardBg: '#ffffff', statsCardText: '#1c1c1e',
      pharmacyHoverBorder: '#1c1c1e',
      footerBg: '#1c1c1e', footerText: '#b0b0b4',
    }),
    buildMonoPreset('رمادي ملكي', '🏛️', 'رقي رمادي بتباين قوي', {
      headerBg: '#3a3a3c', headerText: '#f5f5f7',
      headerNavBg: '#2c2c2e', headerNavText: '#f5f5f7',
      heroBgStart: '#48484a', heroBgMiddle: '#3a3a3c', heroBgEnd: '#2c2c2e',
      heroText: '#f5f5f7',
      heroBtnBg: '#f5f5f7', heroBtnText: '#1c1c1e',
      primaryColor: '#e5e5ea', secondaryColor: '#aeaeb2', accentColor: '#8e8e93',
      statsCardBg: '#48484a', statsCardText: '#f5f5f7',
      pharmacyHoverBorder: '#e5e5ea',
      footerBg: '#1c1c1e', footerText: '#8e8e93',
    }),
    buildMonoPreset('كحلي فحمي', '🌑', 'كحلي عميق بلمسة زرقاء', {
      ...
      primaryColor: '#c8ccd4', secondaryColor: '#8890a0', accentColor: '#586070',
      statsCardBg: '#242a38', statsCardText: '#e8eaf0',
      pharmacyHoverBorder: '#c8ccd4',
    ...
    buildMonoPreset('فحمي فاخر', '🖤', 'أسود فاخر بلمعات فضية', {
      ...
      primaryColor: '#d4d4d4', secondaryColor: '#a0a0a0', accentColor: '#707070',
      statsCardBg: '#1e1e1e', statsCardText: '#f0f0f0',
      pharmacyHoverBorder: '#d4d4d4',
      footerBg: '#050505', footerText: '#a0a0a0',
    }),
    buildMonoPreset('سحاب رمادي', '☁️', 'غيوم ناعمة بدرجات هادئة', {
      ...
      primaryColor: '#4a5060', secondaryColor: '#707880', accentColor: '#a0a8b0',
      statsCardBg: '#ffffff', statsCardText: '#2c2e32',
      pharmacyHoverBorder: '#2c2e32',
      footerBg: '#1c1e22', footerText: '#a0a8b0',
    }),
    buildMonoPreset('حديد صلب', '⚙️', 'صلب مقسّى بتدرجات معدنية', {
      ...
      primaryColor: '#2c3038', secondaryColor: '#585c64', accentColor: '#d0d4dc',
    ...
    buildMonoPreset('بلاتيني', '💎', 'بلاتين نقي بلمعان راقي', {
      ...
      heroText: '#1a1a1a',
      heroBtnBg: '#1a1a1a', heroBtnText: '#ffffff',
      primaryColor: '#333333', secondaryColor: '#666666', accentColor: '#bbbbbb',
      statsCardBg: '#ffffff', statsCardText: '#1a1a1a',
      pharmacyHoverBorder: '#1a1a1a',
      footerBg: '#222222', footerText: '#bbbbbb',
    }),
    buildMonoPreset('سوداء مطلقة', '🖤', 'أسود كامل بتفاصيل بيضاء', {
      ...
      primaryColor: '#ffffff', secondaryColor: '#d0d0d0', accentColor: '#808080',
      statsCardBg: '#111111', statsCardText: '#ffffff',
      pharmacyHoverBorder: '#ffffff',
      footerBg: '#000000', footerText: '#808080',
    }),
    buildMonoPreset('رمادي زجاجي', '🧊', 'زجاج مصنفر بلمعان أنيق', {
      ...
      primaryColor: '#27272a', secondaryColor: '#52525b', accentColor: '#d4d4d8',
